...
class EnemyFactory:
    def __init__(self):
        ...
        self.plane_enemy_image = pg.image.load(r'assets\tiles\PNG\Default size\towerDefense_tile271.png').convert_alpha()
    ...
    def create_enemy(self, enemy_type, waypoints):
        ...
        if enemy_type == 'weak':
            ...
            new_enemy.original_image = self.plane_enemy_image
        else:
            raise ValueError(f"Unknown enemy type: {enemy_type}")

        new_enemy.original_image = pg.transform.scale_by(new_enemy.original_image, 1.5)
